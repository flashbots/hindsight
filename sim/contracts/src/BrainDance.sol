...
/*
Credit: mouseless [rusty-sando](https://raw.githubusercontent.com/mouseless-eth/rusty-sando/8bed4dbc27e8dac5c1f38cff595bdc082f1f892b/contract/src/BrainDance.sol)
*/
...
contract BrainDance {
    ...
    function calculateSwapV2(
        ...
        uint actualAmountIn = IERC20(inputToken)
            .balanceOf(address(targetPair))
            .sub(reserveIn);
    ...
    function calculateSwapV3(
        ...
        (int amount0, int amount1) = targetPool.swap(
            address(this),
            zeroForOne,
            amountIn,
            sqrtPriceLimitX96,
    ...
    function uniswapV3SwapCallback(
        ...
        (bool isZeroForOne, address inputToken) = abi.decode(
            _data,
            (bool, address)
        );
